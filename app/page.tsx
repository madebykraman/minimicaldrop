    ...
    <main className="drop-home">
      <header className="drop-home-nav">
        <Link href="/" className="drop-home-brand" aria-label="MINIMICAL DROP home">
          <Image src="/assets/branding/01_drop_main_logo.svg" alt="MINIMICAL DROP" width={168} height={44} priority />
        </Link>
      ...
      <section className="drop-home-showcase" aria-label="MINIMICAL DROP workspace preview">
        <div className="drop-window">
          <div className="drop-window-top">
            <div className="drop-window-brand"><Image src="/assets/branding/03_drop_symbol_mark.svg" alt="" width={22} height={22} /><span>DROP</span></div>
      ...
      <section className="drop-home-private">
        <div className="drop-private-mark"><Image src="/assets/branding/03_drop_symbol_mark.svg" alt="MINIMICAL DROP" width={54} height={54} /></div>
