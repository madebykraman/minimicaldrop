...
if (!source.includes('/* v1-delete-polish */')) {
  ...
  source = source.replace('/* v1-delete-polish */', '')
  source = source.replace("const [search, setSearch] = useState('');", "const [search, setSearch] = useState('');")
