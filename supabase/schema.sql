...
create table if not exists projects (
  ...
  delivery_status text not null default 'in_progress' check (delivery_status in ('in_progress','ready','delivered','archived')),
  client_message text,
  created_at timestamptz not null default now()
);
...
declare
  v_limit bigint; v_expires_at timestamptz; v_disabled_at timestamptz; v_used bigint; v_upload_id uuid;
begin
